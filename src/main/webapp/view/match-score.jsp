...
<div class="scoreboard-div">
    ...
    <div class="player-scoreboard-div" id="first-player-scoreboard">
        ...
        <div class="player-name-div" style="right: 5%">
        ...
        <div class="player-score-cell-div" style="right: 50%">
            <h4>POINT</h4>
            <h2><%= match.getPlayer1().getTennisScore(match.isTieBreak()) %>
            </h2>
        </div>
        <div class="player-score-cell-div" style="right: 65%">
            <h4>GAME</h4>
            <h2><%= match.getPlayer1().getGame() %>
            </h2>
        </div>
        <div class="player-score-cell-div" style="right: 80%">
            <h4>SET</h4>
    ...
    <div class="player-scoreboard-div" id="second-player-scoreboard">
        ...
        <div class="player-score-cell-div" style="left: 80%">
            <h4>SET</h4>
            <h2><%= match.getPlayer2().getSet() %>
            </h2>
        </div>
        <div class="player-score-cell-div" style="left: 65%">
            <h4>GAME</h4>
            <h2><%= match.getPlayer2().getGame() %>
            </h2>
        </div>
        <div class="player-score-cell-div" style="left: 50%">
            <h4>POINT</h4>
            <h2><%= match.getPlayer2().getTennisScore(match.isTieBreak()) %>
            </h2>
        </div>
        <div class="player-name-div" style="left: 5%">
